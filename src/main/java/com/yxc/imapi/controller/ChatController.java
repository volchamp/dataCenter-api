...
import com.yxc.imapi.model.UserChatSession;
...
//        String sendUserId = merchantmsg.getSendUserId();
        ...
        try {
            ...
            imUserChatSession2.setUserId(sendUserId);
            imUserChatSession2.setFriendId(receiverUserId);
            imUserChatSession2.setUnreadCount(0);
            imUserChatSession2.setMessage(message);
            imUserChatSession2.setSendDate(date);
            imUserChatSession2.setChannel("");
            imUserChatSession2.setSendUser(sendUserId);
            imUserChatSession2.setReceiver(receiverUserId);
            imUserChatSession2.setContentType(contentType);
            imUserChatSession2.setPictureUrl(pictureUrl);
            ...
            boolean latestFlag2 = chatService.addLetestMessage(imUserChatSession2, 0);

            //接收人：
            UserChatSession imUserChatSession = new UserChatSession();
            imUserChatSession.setUserId(receiverUserId);
            imUserChatSession.setFriendId(sendUserId);
            imUserChatSession.setUnreadCount(1);
            imUserChatSession.setMessage(message);
            imUserChatSession.setSendDate(date);
            imUserChatSession.setChannel("");
            imUserChatSession.setSendUser(sendUserId);
            imUserChatSession.setReceiver(receiverUserId);
            imUserChatSession.setContentType(contentType);
            imUserChatSession.setPictureUrl(pictureUrl);
